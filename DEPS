...
vars = {
  ...
  'custom_flutter_skia_git': 'https://github.com/GiacomoPignoni/skia.git',
  'skia_revision': '8ac5d3a6cef840545af287bc118d01cd35b70d25',
...
deps = {
  ...
  'engine/src/flutter/third_party/skia':
   Var('custom_flutter_skia_git') + '@' +  Var('skia_revision'),
