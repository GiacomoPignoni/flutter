...
class CkPicture implements LayerPicture, StackTraceDebugger {
  ...
  Future<Object?> toCanvas(int width, int height) async {
    final CkSurface ckSurface = CanvasKitRenderer.instance.pictureToImageSurface;
    ckSurface.setSize(BitmapSize(width, height));
    ...
    skiaSurface.flush();
    return (ckSurface as CkOnscreenSurface).hostElement;
  }
