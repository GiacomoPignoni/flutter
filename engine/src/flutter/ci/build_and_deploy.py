...
def main():
  ...
  build("./flutter/ci/builders/custom_builders/host.json")
  build("./flutter/ci/builders/custom_builders/mac.json")
  build("./flutter/ci/builders/custom_builders/android_debug.json")
  build("./flutter/ci/builders/custom_builders/android_aot.json")
  build("./flutter/ci/builders/custom_builders/ios.json")
  build("./flutter/ci/builders/custom_builders/web.json")
